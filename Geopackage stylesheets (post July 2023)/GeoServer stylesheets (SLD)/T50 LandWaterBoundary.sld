...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>OS Terrain&#8482; 50 (Land Water Boundary)</Name>
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>water_level_category</ogc:PropertyName>
        ...
        <Rule>
          ...
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>water_level_categoryy</ogc:PropertyName>
